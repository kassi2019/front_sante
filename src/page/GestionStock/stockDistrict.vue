                ...
                <div class="col-md-6">
                  ...
                  <div class="input-group">
                    ...
                    <input
                      ...
                      id="inputWithIcon"
                      :value="
                        AfficheCodeEquipementModifier(ObjetModifier.equipement_id)
                      "
                      disabled
                    />
                  </div>
...
export default {
  ...
  visiblePages() {
    ...
    totalPages() {
      return Math.ceil(this.getterTypeEquipementStockDistricts.length / this.itemsPerPage);
    },
    loading() {
  ...
  methods: {
    ...mapActions([
      ...
      "getTypeEquipementDansStockDistrict","supprimerStockDistrict","modifierStockDistrict"
    ]),
    formatDate,
