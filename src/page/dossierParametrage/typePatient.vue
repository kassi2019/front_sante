    ...
    <div class="row column_title">
      <div class="col-md-12">
        <div class="page_title">
          <h2 style="font-weight: bolder;font-family:Georgia, 'Times New Roman', Times, serif;">Type patient</h2>
        </div>
      </div>
    </div>
                  ...
                  <tr v-for="(data, index) in paginatedData" :key="data.id">
                    ...
                    <td class="button_block">
                      ...
                      <button
                        ...
                        @click.prevent="supprimerTypePatient(data.id)"
                      >
          ...
          <div class="modal-content">
            ...
            <div class="modal-footer">
              ...
              <button
                ...
                class="btn btn-success"
                :disabled="loading"
                @click.prevent="modifierTypePatients()"
              >
                Modifier
              </button>
            </div>
...
export default {
  ...
  computed: {
    ...
    ...mapGetters(["getterTypePatient", "loading"]),
 visiblePages() {
      let pages = [];
    ...
    paginatedData() {
      ...
      return this.getterTypePatient.slice(
        startIndex,
        startIndex + this.itemsPerPage
      );
    },
    totalPages() {
      return Math.ceil(this.getterTypePatient.length / this.itemsPerPage);
    },
    loading() {
  ...
  methods: {
    ...mapActions([
      "getTypePatient",
      "enregistrerTypePatient",
      "supprimerTypePatient",
      "modifierTypePatient",
    ]),
 changePage(page) {
    ...
    async enregistretypePatient() {
      ...
      this.enregistrerTypePatient(ob);
